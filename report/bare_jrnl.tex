...
\item Until it coverage, and if the cosmetric close to 1, we switch back to Kalman
...
The Kalman and Adjusted Particle filter is performed on the simulated data.

\section{Real World Applications}


\section{Conclusion}
We compared the performance of Kalman Filters and Advanced Particle Filter. The result shows that 
Advanced Particle Filters performed can better track the drone than Kalman Filter. The reason canbbe listed as below:
