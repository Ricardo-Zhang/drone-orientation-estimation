...
Subtracting the single differential, we have double differential, the the clock biases is removed and the absolute orientation
is achieved, but the residue is polluted by integer ambiguity. In this study, the spatio double differential
